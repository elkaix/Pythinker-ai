...
| `novita` | LLM (Novita AI: hosted model APIs, OpenAI-compatible) | [novita.ai](https://novita.ai) |
...
| `tools.exec.denyPatterns` | `[]` | Optional extra regex denylist entries layered on top of built-in dangerous-command guards. |
