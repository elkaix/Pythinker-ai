    ...
    >
      <Streamdown
        ...
        components={{
          ...
          img({ src, alt, node: _n, className: imgClassName, ...props }) {
            void _n;
          ...
          li({ children: kids, node: _n, className: itemClassName, ...props }) {
            void _n;
            const link = inlineLinkPreviewFromChildren(kids);
            if (link) {
              return (
            ...
            return <li className={itemClassName} {...props}>{hl(kids, "li")}</li>;
          },
