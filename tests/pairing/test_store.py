...
from pythinker.pairing import __all__ as pairing_all
from pythinker.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from pythinker.pairing."""
    import pythinker.pairing as pkg
