...
from pythinker.channels.websocket import (
    WebSocketChannel,
    WebSocketConfig,
    _is_valid_chat_id,
...
def test_default_config_includes_safe_bind_and_streaming() -> None:
    ...
    assert defaults["websocketRequiresToken"] is True
...
def test_issue_route_secret_matches_bearer_and_header() -> None:
    ...
    x_headers = Headers([("X-Pythinker-Auth", "my-secret")])
...
def test_registry_discovers_websocket_channel() -> None:
    from pythinker.channels.registry import load_channel_class
