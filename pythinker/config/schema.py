...
class ProviderConfig(Base):
    ...
    api_type: Literal["auto", "chat_completions", "responses"] = "auto"  # Request API surface; only supported for providers.openai
...
class ExecToolConfig(Base):
    ...
    enable: bool = True
    timeout: int = Field(default=60, ge=0)  # Hard timeout in seconds; 0 disables the limit
    path_append: str = ""
...
class MCPServerConfig(Base):
    ...
    cwd: str = ""  # Stdio: optional working directory for server process state/cache
