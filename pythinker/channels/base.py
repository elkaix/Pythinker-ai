...
class BaseChannel(ABC):
    ...
    to integrate with the pythinker message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                ...
                from pythinker.providers.transcription import GroqTranscriptionProvider
    ...
    async def _handle_message(
        ...
        This method checks permissions and forwards to the bus. The seed
        carries identity hints; AgentLoop._normalize_context turns the
        seed into a full RequestContext when the message is picked up.
        ...
        Args:
            ...
            is_dm: True when this message is a direct message; on denial the
                base class issues a one-time pairing code so the owner can
                approve the sender via ``/pairing approve <code>``.
        """
